...
$(".content-l button").click(function () {
  ...
  if (index % 2 == 1) {
    ...
    $(".content-l img").attr("style", "bottom: 0px;");
    $(".content-l").attr("style", "width: 63%;");
    $(".content-r").attr("style", "width: 37%;");
    $(".img").attr("style", "padding: 10px; transform: scale(1);");
    $(".img img").attr(
      "style",
    ...
    $(".content-l img").attr("style", "bottom: -500px;");
    $(".content-l").attr("style", "width: 40%;");
    $(".content-r").attr("style", "width: 60%;");
    $(".img").attr("style", "padding: 0px;  ");
    $(".img img").attr(
      "style",
